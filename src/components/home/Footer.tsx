  ...
  return (
      <Flex className='text-white sm:h-[500px] sm:px-10 py-20 flex flex-col justify-between 3xl:mx-auto 3xl:container'>
                  ...
                  <Box className='sm:px-10'>
                    <BodyText>FUSHUN</BodyText>
                      ...
                      <Box className='text-white text-xl sm:text-2xl my-3'>
                        <BodyText className='py-2 font-normal'>Company</BodyText>
                        <BodyText className='py-2 font-normal'>About Us</BodyText>
                        <BodyText className='py-2 font-normal'>FAQ</BodyText>
                      </Box>
                  </Box>
              </Flex>
          </Flex>
          ...
          <Box className='w-full xl:w-[47%]'>
            <BodyText>Built by a <Text as='span' >Beamstudio</Text> on the shoulders of <Text as='span' className='underline'>machine learning giants</Text>. Funshi AI is a registered trademark and subject to copyright worldwide.</BodyText>
          </Box>
      </Flex>
  )
}
